...
class DocumentState(object):
    ...
    def finalize(self):
        ...
        # segment_subtoken_map is in the same shape as segments
        # why flatten it ? Because the BERT output will be flatten, [num_subtokens, BERT_dim]
...
def get_aligned_pos(orig_tokens):
    orig_list = orig_tokens.split()
    ### Output
    bert_tokens = []
