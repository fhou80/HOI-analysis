...
class Vocabulary:
    ...
    @staticmethod
    def load(path, insert_unk):
        voca = Vocabulary()
        voca.load_from_file(path, insert_unk)
        return voca

    def load_from_file(self, path, insert_unk):
        self.word2id = {}
        self.id2word = []
        self.counts = []
        ...
        if Vocabulary.unk_token not in self.word2id and insert_unk:
